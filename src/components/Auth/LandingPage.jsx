      ...
      <nav className="relative z-10 px-6 py-5 flex items-center justify-between max-w-6xl mx-auto w-full">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="text-sm text-slate-400 hover:text-white transition font-medium px-4 py-2 rounded-lg hover:bg-slate-800"
          >
            Sign In
          </button>
          <button
            onClick={() => navigate('/login', { state: { tab: 'signup' } })}
            className="text-sm bg-brand-600 hover:bg-brand-500 text-white font-semibold px-4 py-2 rounded-lg transition"
          >
            Get Started
          </button>
        </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <div className="relative">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <button
              onClick={() => navigate('/login', { state: { tab: 'signin' } })}
              className="inline-flex items-center gap-3 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-200 font-semibold px-8 py-4 rounded-xl transition text-base"
            >
              Sign in
            </button>
          </div>
